...
import { ArrowRight, UserCircle, Target, MessageCircle, Edit2 } from 'lucide-react';
...
export default function ScenarioCard({ scenario, onSelect, onEdit }: ScenarioCardProps) {
  return (
    <div
    ...
    >
      ...
      <button
        ...
        className="w-full mt-auto py-3 px-4 rounded-xl bg-slate-50 text-slate-900 font-semibold border border-slate-200 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all flex items-center justify-center gap-2"
      >
        Start Practice
